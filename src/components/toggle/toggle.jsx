    ...
    return(
        <div className='toggle-container'>
            ...
            <div className='toggle' style={{background: theme.toggle_bg}}>
              <div className='dot-container' id="dot-container" onClick={() => setTheme(Theme.dark_blue)}>
              ...
              <div className='dot-container' id="dot-container" onClick={() =>setTheme(Theme.light_gray)}>
              ...
              <div className='dot-container' id="dot-container" onClick={() => setTheme(Theme.dark_violet)}>
