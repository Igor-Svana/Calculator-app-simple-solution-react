    ...
    return(
        <div className='toggle-container'>
            ...
            <div className='toggle' style={{background: theme.toggle_bg}}>
              <div className='dot-container'  onClick={() => setTheme(Theme.dark_blue)}>
                <label className="dot-label" >1</label>
              ...
              <label className="dot-label" >2</label>
              ...
              <label className="dot-label" >3</label>
